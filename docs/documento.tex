...
\begin{center}
    ...
    {\normalsize \textbf{Advisor:} Andrés Marino Álvarez Meza, PhD}\\
\end{center}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{../../EEGNet_y_Shallow_ConvNet/docs/monografia/figuras/Interpretability.png}
...
\begin{itemize}
    \item \textbf{Undergraduate thesis (monographic modality):} An academic document submitted at the National University of Colombia – Manizales Campus, as a graduation requirement for the Electronic Engineering program. The work consolidates the methodological framework, experimental results, and clinical implications of EEGNet and Shallow ConvNet applied to EEG signals, linking the findings with tau protein propagation trajectories in the progression of Alzheimer’s disease and other related dementias.
...
I deeply thank the National University of Colombia – Manizales Campus, for the academic and technical support provided during the development of this undergraduate research work. I extend my gratitude to the Advisory Committee of the Curricular Programs of Electrical and Electronic Engineering for approving the monographic modality and allowing the consolidation of this project within the institutional framework.

To the research group, for their methodological guidance, the constant exchange of ideas, and their support in the validation of results. In particular, I express my recognition to Professor Andrés Marino Álvarez Meza, PhD, for his invaluable scientific, clinical, and computational guidance, as well as for his academic and personal support throughout all stages of the process. His orientation was fundamental for the construction of the methodological framework and the interpretation of the clinical findings related to tau protein and the progression of Alzheimer’s disease.

To my fellow research peers and academic community, whose contributions and feedback enriched the discussion and strengthened the reproducibility of the pipeline. Their comments and suggestions were key to improving the technical quality and clarity of the academic products generated.

Finally, I thank my family for their unconditional support, patience, and constant motivation. Their emotional and personal accompaniment was essential to successfully completing this work and maintaining commitment at every stage of the project.

This work is the result of a collective, technical, and human effort, reflecting the integration of academic knowledge, applied research, and personal support, with impact both in the scientific and clinical domains.
